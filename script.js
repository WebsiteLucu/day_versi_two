...
const _slideLima = function () {
  ...
  const trims = document.getElementById('terima kasih');
...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb", " ", "08 November 2024 dengan senang hati mau bilanggg...", " ", "<b>Happy Sweet Seventeen</b>", " ", "Kepada cewe dry teks yang satu ini, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya", , " ", "Wassalamualakaikum Wr. Wb", " ", "- cewe hirotaka:)"],
  startDelay: 4000,
  speed: 75,
